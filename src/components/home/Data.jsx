...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Kanishk Purohit
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Web Developer
        </h3>
        <p className="home__description">
            I'm a Fullstack developer , and i am very passionate and dedicated to my work.
        </p>
